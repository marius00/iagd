...
namespace IAGrim.Database.Model {
    public class UnlootedStashItem : BaseItem, PlayerHeldItem, RecordCollection {
        ...
        public virtual int StashTab { get; set; }
        public virtual int StashCoordinateX { get; set; }
        public virtual int StashCoordinateY { get; set; }
