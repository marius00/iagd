        ...
        private readonly Dictionary<string, string> _tables = new Dictionary<string, string> {
            ...
            {"PlayerItem", """
                CREATE TABLE "PlayerItem" (
                	...
                	"created_at"	INTEGER, AscendantAffixNameRecord TEXT, AscendantAffix2hNameRecord TEXT, RerollsUsed INT, AffixRerollsUsed INT,
                	PRIMARY KEY("Id")
                )
                """},
        };
