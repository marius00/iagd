...
namespace StatTranslator {
    public class EnglishLanguage : ILocalizedLanguage {
        ...
        private readonly Dictionary<string, string> _stats = new Dictionary<string, string> {
            ...
            {"iatag_ui_onlinefeatures", "Online Features" },
            {"iatag_ui_onlinefeatures_body", "Online features in Item Assistant ensures that your items are automatically backed up to the cloud.\r\n\r\nThe feature also gives you a unique ID which your friends can use to search your items." },
