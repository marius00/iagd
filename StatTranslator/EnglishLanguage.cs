...
namespace StatTranslator {
    public class EnglishLanguage : ILocalizedLanguage {
        ...
        private readonly Dictionary<string, string> _stats = new Dictionary<string, string> {
            ...
            {"iatag_html_darkmode", "Dark mode"},
            {"iatag_html_lightmode", "Light mode"},
            ...
            {"iatag_ui_backup_logout_sucessful_body", "You have been signed out of online backups\n\nGood luck!" },
            {"iatag_ui_backup_logout_sucessful_header", "Online backups disabled" },
