      ...
      if (this.state.showNoMoreInstantSyncWarning) {
        ...
        return (
            <div className={'App ' + (this.state.isDarkMode ? 'App-dark' : 'App-Light')}>
                ...
                {this.state.activeTab === 0 && this.state.isGrimParsed && this.state.isFirstRun &&
                    <FirstRunHelpThingie/>}
                {this.state.isLoading && isEmbedded && <Spinner/>}


                {this.state.activeTab === 0 && !isEmbedded ?
                    <MockItemsButton onClick={(items) => this.setItems(items)}/> : ''}
                {this.state.activeTab === 3 && <CharacterListContainer/>}

                {this.state.activeTab === 0 && this.state.showModFilterWarning > 0 &&
                    <ModFilterWarning numOtherItems={this.state.showModFilterWarning}/>}
                ...
                {this.state.activeTab === 1 &&
                    <CollectionItemContainer items={this.state.collectionItems} aggregate={this.state.itemAggregate}/>}
