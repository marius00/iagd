...
import { setItems, addItems, setLoadingStatus, showMessage, setCollectionItems } from './actions';
...
declare abstract class data {
  ...
  public static globalSetCollectionItems(items: ICollectionItem[]): {};
...
if (typeof data === 'object') {
  ...
  data.globalSetCollectionItems = setCollectionItems;
}
/* == END MAGIC == */
