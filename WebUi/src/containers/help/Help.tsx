...
const helpEntries = [
...

    {
        ...
        Inside Grim Dawn itself, under "Settings"`)}
            ...
            After disabling cloud saving you still need to <a href="https://forums.crateentertainment.com/t/how-to-move-your-saves-from-steam-cloud-to-grim-dawns-default-location/28921">copy
    ...
    },
    {
        ...
        This is expected`)}
            ...
            You simply need to <a href="https://forums.crateentertainment.com/t/how-to-move-your-saves-from-steam-cloud-to-grim-dawns-default-location/28921">copy them to a new folder</a>,
    ...
    },
    {
        ...
        body: () => <div>
            ...
            <br/>
            Any time you loot an item it will be synced up to the cloud. If anything happens and you need to reinstall IA, all you need to do is login with the same e-mail address, and IA
    ...
    },
    {
        ...
        body: () => <div>
            ...
            If you have recently enabled this on the <i>my documents</i> folder, it's most likely preventing Item Assistant from writing to files under <i>my games</i>, which is under my
            documents. <br/><br/>
